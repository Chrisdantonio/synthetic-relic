...
# Timings (in seconds) - Drawing & voice now have NO time limits, controlled by user button clicks
# These are kept as fallbacks if you want to re-enable time limits
DRAWING_DURATION = 300        # Fallback max (rarely hit with button control)
VOICE_DURATION = 60           # Fallback max (rarely hit, speech naturally ends)
